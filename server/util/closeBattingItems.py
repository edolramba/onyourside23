...
class closeBattingItems:
    ...
    def __init__(self):
        ...
        ten_day_list = self.make_use_data_list(0)
        after_day_count = 0
        ...
        for i in ten_day_list:
            ...
            for thema in thema_list:
                ...
                if to_list_df_higher_chongjum[0][1] in list_dup_check:
                    ...
                    after_day_total_list.append("%s / %s / %s" % (to_list_df_higher_chongjum[0][1], to_list_df_higher_chongjum[0][0], to_list_df_higher_chongjum[0][2]))
