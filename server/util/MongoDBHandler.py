...
class MongoDBHandler:
    ...
    def find_item(self, condition=None, db_name=None, collection_name=None):
        """
        MongoDB에 하나의 문서(document)를 검색하기 위한 메소드입니다. 
    ...
    def find_items(self, condition=None, db_name=None, collection_name=None):
        """
        MongoDB에 다수의 문서(document)를 검색하기 위한 메소드입니다. 
    ...
    def find_items_distinct(self, condition=None, db_name=None, collection_name=None, distinct_col=None):
        """
        MongoDB에 다수의 문서(document)를 검색하기 위한 메소드입니다. 
        :distinct_col: 하나로 합칠 collection
        :return Cursor: Cursor를 반환합니다.
        """
        if condition is None or not isinstance(condition, dict):
            condition = {}
    ...
    def delete_items(self, condition=None, db_name=None, collection_name=None):
        """
        MongoDB에 다수의 문서(document)를 삭제하기 위한 메소드입니다. 
